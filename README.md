...
> **v6.13.10** — module registry — bootstrap Azure + substrat AISIA
...
| `image_tag` | Tag d'image AISIA (pour tagging Azure) | `string` | `"v6.13.10"` | non |
...
| `image_tag` | `string` | `"v6.13.10"` | Tag d'image AISIA à déployer (utilisé pour le tagging Azure). |
