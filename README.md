...
> **v6.12.95** · code **v6.12.96** tagué, registry/images LIVE encore **v6.12.95** — module registry — bootstrap Azure + substrat AISIA
...
| `image_tag` | Tag d'image AISIA (pour tagging Azure) | `string` | `"v6.12.96"` | non |
...
| `image_tag` | `string` | `"v6.12.96"` | Tag d'image AISIA à déployer (utilisé pour le tagging Azure). |
