...
> **v6.13.19** · code **v6.14.1** (worktree candidat non tagué), registry/images LIVE encore **v6.13.19** — module registry — bootstrap Azure + substrat AISIA
...
| `image_tag` | Tag d'image AISIA (pour tagging Azure) | `string` | `"v6.14.1"` | non |
...
| `image_tag` | `string` | `"v6.14.1"` | Tag d'image AISIA à déployer (utilisé pour le tagging Azure). |
