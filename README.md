...
> **v6.12.93** · code **v6.12.94** tagué, registry/images LIVE encore **v6.12.93** — module registry — bootstrap Azure + substrat AISIA
...
| `image_tag` | Tag d'image AISIA (pour tagging Azure) | `string` | `"v6.12.94"` | non |
...
| `image_tag` | `string` | `"v6.12.94"` | Tag d'image AISIA à déployer (utilisé pour le tagging Azure). |
