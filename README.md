...
> **v6.12.81** — module registry — bootstrap Azure + substrat AISIA
...
| `image_tag` | Tag d'image AISIA (pour tagging Azure) | `string` | `"v6.12.81"` | non |
...
| `image_tag` | `string` | `"v6.12.81"` | Tag d'image AISIA à déployer (utilisé pour le tagging Azure). |
