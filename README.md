...
> **v6.12.91** · code **v6.12.92** tagué, registry/images LIVE encore **v6.12.91** — module registry — bootstrap Azure + substrat AISIA
...
| `image_tag` | Tag d'image AISIA (pour tagging Azure) | `string` | `"v6.12.92"` | non |
...
| `image_tag` | `string` | `"v6.12.92"` | Tag d'image AISIA à déployer (utilisé pour le tagging Azure). |
